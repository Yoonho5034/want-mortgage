...
export default function Home({ User, number }) {
  ...
  // 금리 정보
  const Rate = [
    { value: "Apt", rate: "연 4.31% ~ 5.56%" },
    { value: "Villa", rate: "연 4.81% ~ 6.06%" },
    "( 2025년 9월 기준 )",
  ];
  const handleCall = () => {
  ...
  const Info = [
    ...
    },
    {
      ...
      title: "상환방법",
      contents: [
        "- 3년/5년 한도거래 후, 잔여기간 동안 원금의 50% 매월 균등 분할 상환",
        "- 대출 전기간 원금의 100% 매월 균등분할 상환",
        "- 대출 전기간 원금의 50% 매월 균등분할 상환(잔여 원금의 50%는 만기일시상환)",
      ],
    },
  ];
